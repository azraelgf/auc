(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".coming__body")) new swiper_core_Swiper(".coming__body", {
            ...
            if (document.querySelector(".products__body")) new swiper_core_Swiper(".products__body", {
                modules: [ Pagination, Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                const activeBlock = document.querySelector("._insubmenu-open"), activeLink = document.querySelector("._insubmenu-open--active");
                activeBlock ? activeBlock.classList.remove("_insubmenu-open") : null;
                activeLink ? activeLink.classList.remove("_insubmenu-open--active") : null;
            ...
            if (targetElement.closest("[data-inparent]")) {
                const numMenu = targetElement.dataset.inparent ? targetElement.dataset.inparent : null, subMenu = document.querySelector(`._submenu-open [data-insubmenu="${numMenu}"]`);
                if (subMenu) {
                    ...
                    if (activeLink && activeLink !== targetElement) {
                        ...
                        activeBlock.classList.remove("_insubmenu-open");
                    }
            ...
            if (targetElement.closest(".submenu__btn")) {
                const activeBlock = document.querySelector("._submenu-open");
                const activeLink = document.querySelector("._submenu-open--active");
                activeBlock ? activeBlock.classList.remove("_submenu-open") : null;
                activeLink ? activeLink.classList.remove("_submenu-open--active") : null;
            }
            if (targetElement.closest(".submenu__content .submenu__back")) {
                const activeBlock = document.querySelector("._insubmenu-open");
                const activeLink = document.querySelector("._insubmenu-open--active");
                activeBlock ? activeBlock.classList.remove("_insubmenu-open") : null;
                activeLink ? activeLink.classList.remove("_insubmenu-open--active") : null;
            }
            if (targetElement.closest(".btn-search")) document.querySelector(".header-middle__search").classList.toggle("_show");
            if (targetElement.closest(".product__btn")) targetElement.classList.toggle("_active");
        }
        window["FLS"] = false;
        isWebp();
        menuInit();
